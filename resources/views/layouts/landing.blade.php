...
<h1>JAZAL PART UNDER CONSTRUCTION</h1>
{{-- 
<div id="headerwrap">
    <div class="container">
        <div class="row centered">
            <div class="col-lg-12">
                <h1><b><a href="#">SALARY MANAGMENT SYSTEM</a></b></h1>
                <h3>A <a href="#">Free Source</a> Solution To Maintain Your Personal Expenses Tracked And Well Efficently Spent With Our Premium Feature </h3>
                <h3><a href="{{ url('/register') }}" class="btn btn-lg btn-success">{{ trans('adminlte_lang::message.gedstarted') }}</a></h3>
            </div>
            <div class="col-lg-2">
                <h5>Amazing Backend Dashboard</h5>
                <p>Based On the expereienced UI Experts</p>
    ...
    <div class="container">
        <div class="row centered">
            ...
            <div class="col-lg-4">
                ...
                <p>{{ trans('adminlte_lang::message.see') }} <a href="#">{{ trans('adminlte_lang::message.pullrequests') }}</a></p>
            </div>
            <div class="col-lg-4">
...
<div id="c">
    <div class="container">
        <p>
            <a href="#"></a><b>ABC Cafteria</b></a>. A <a href="#">Have it your way.</a> It takes two hands to hold a Whopper <br/>
